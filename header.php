...
<nav id="sidebar">
  <div class="navbar">
    ...
    <ul>
      ...
      <li><a href="crud/cadastrar_servidor.php" class="nav-link" <?php if ($_SESSION['Perfil'] != 1) {
        echo 'onclick="event.preventDefault(); showPermissionAlert();"';
      } ?>>
      ...
      <li><a href="crud/editar-perfil-usuario.php" class="nav-link" <?php if ($_SESSION['Perfil'] != 1) {
        echo 'onclick="event.preventDefault(); showPermissionAlert();"';
      } ?>>
